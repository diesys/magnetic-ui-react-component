...
import { Toggle, Slider, Select, Section, EffectControl } from './Controls';
...
const DEFAULT_CONFIG: MagneticProps = {
  radius:           150,
  falloff:          'quadratic',
  mode:             'attract',
  disabled:         false,
...
export function Demo() {
  const [config, setConfig] = useState<MagneticProps>(DEFAULT_CONFIG);
        ...
        >
            ...
            <Section title="Core" tooltip="Activation radius, interaction mode, falloff curve and spring physics">
              ...
              <Select
                ...
                onChange={v => set('falloff', v as FalloffType)} dimmed={isDisabled}
              />
